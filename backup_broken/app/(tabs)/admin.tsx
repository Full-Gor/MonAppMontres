...
export default function AdminScreen() {
    ...
    const loadData = async () => {
        ...
        setStats({
            ...
            productsInCarts: 0, // Placeholder, will be fetched
            productsInFavorites: 0, // Placeholder, will be fetched
            productsSold: 0, // Placeholder, will be fetched
        });
    };
    ...
    const handleSaveProduct = async () => {
        ...
        try {
            if (editingProduct.id) {
                ...
                const { error } = await supabase
                    ...
                    .update({
                        ...
                        category: editingProduct.category || 'classique',
                        mechanism: editingProduct.mechanism || '',
                        material: editingProduct.material || '',
                        waterResistance: editingProduct.waterResistance || '',
            ...
            console.error('Erreur save produit:', error);
        }
    };
        ...
        >
            ...
            {activeTab === 'dashboard' && (
                <>
                    ...
                    {/* Nouvelles statistiques produits */}
                    <Text style={styles.sectionSubtitle}>Statistiques Produits</Text>
                    <View style={styles.statsGrid}>
                        <View style={[styles.statCard, { backgroundColor: '#E91E63' }]}>
                            <MaterialIcons name="add-shopping-cart" size={30} color="#fff" />
                            <Text style={styles.statNumber}>{stats.productsInCarts}</Text>
                            <Text style={styles.statLabel}>Dans paniers</Text>
                        </View>
                        <View style={[styles.statCard, { backgroundColor: '#FF5722' }]}>
                            <MaterialIcons name="favorite" size={30} color="#fff" />
                            <Text style={styles.statNumber}>{stats.productsInFavorites}</Text>
                            <Text style={styles.statLabel}>En favoris</Text>
                        </View>
                        <View style={[styles.statCard, { backgroundColor: '#795548' }]}>
                            <MaterialIcons name="check-circle" size={30} color="#fff" />
                            <Text style={styles.statNumber}>{stats.productsSold}</Text>
                            <Text style={styles.statLabel}>Vendus</Text>
                        </View>
                        <View style={[styles.statCard, { backgroundColor: '#607D8B' }]}>
