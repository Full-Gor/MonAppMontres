...
-- 2. Créer la table products (compatible avec l'application)
...
-- 10. Insérer l'utilisateur admin par défaut (avec vérification)
DO $$
BEGIN
...
-- 11. Supprimer les anciens produits s'ils existent et insérer les nouveaux
DELETE FROM products;

-- Insérer les produits par catégorie (avec colonne category VARCHAR)
-- Produits Classiques
